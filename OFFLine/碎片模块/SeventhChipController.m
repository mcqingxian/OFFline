...
@interface SeventhChipController ()

@property (nonatomic, strong)UIImageView * myImageView;

@end

@implementation SeventhChipController
...
- (void)createSubViews
{
    ...
    UIImage *image = [UIImage imageNamed:@"碎片7 - 副本.png"];
    ...
    UILabel * lab = [UILabel labelWithFrame:CGRectMake(btn.width / 2.0 + 20, btn.height / 5.0 * 4 + 20, 200, 40) fontSize:30.0 textAlignment:NSTextAlignmentLeft text:@"碎片No.7"];
