...
@interface ForthChipController ()

@property (nonatomic, strong)UIImageView * myImageView;

@end

@implementation ForthChipController
...
- (void)createSubViews
{
    ...
    UIImage *image = [UIImage imageNamed:@"碎片4 - 副本.png"];
    ...
    UILabel * lab = [UILabel labelWithFrame:CGRectMake(btn.width / 3.0, btn.height / 2.0 + 10, 200, 40) fontSize:30.0 textAlignment:NSTextAlignmentLeft text:@"碎片No.4"];
