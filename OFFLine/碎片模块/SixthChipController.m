...
@interface SixthChipController ()

@property (nonatomic, strong)UIImageView * myImageView;

@end

@implementation SixthChipController
...
- (void)createSubViews
{
    ...
    UIImage *image = [UIImage imageNamed:@"碎片6 - 副本.png"];
    ...
    UILabel * lab = [UILabel labelWithFrame:CGRectMake(20, btn.height / 5.0 * 4 + 20, 200, 40) fontSize:30.0 textAlignment:NSTextAlignmentLeft text:@"碎片No.6"];
