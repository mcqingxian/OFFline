...
@interface SecondChipController ()

@property (nonatomic, strong)UIImageView * myImageView;

@end

@implementation SecondChipController
...
- (void)createSubViews
{
    ...
    UIImage *image = [UIImage imageNamed:@"碎片2 - 副本.png"];
    ...
    UILabel * lab = [UILabel labelWithFrame:CGRectMake(btn.width / 3.0, btn.height / 4.0, 200, 40) fontSize:30.0 textAlignment:NSTextAlignmentLeft text:@"碎片No.2"];
