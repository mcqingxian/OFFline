...
-(instancetype)initWithFrame:(CGRect)frame Style:(Style)style
{
    if(self=[super initWithFrame:frame])
    {
        ...
        _viewContent.backgroundColor=[UIColor colorWithRed:16 / 255.0 green:16 / 255.0 blue:16 / 255.0 alpha:1.0];
        ...
        _lbTitle.textColor=[UIColor lightGrayColor];
        _lbTitle.backgroundColor=[UIColor colorWithRed:16 / 255.0 green:16 / 255.0 blue:16 / 255.0 alpha:1.0];
        ...
        _lbText.textColor = [UIColor lightGrayColor];
        ...
        if(_style==ALERT)
        {
            ...
            [_btnYes setBackgroundColor:MyBlueColor];
        ...
        else
        {
            ...
            [_btnNo setBackgroundColor:MyBlueColor];
