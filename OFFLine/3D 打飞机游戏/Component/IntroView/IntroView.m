...
+(void)showTitle:(NSArray*)arr Block:(void (^)())block
{
    ...
    viewIntro.imgView=[[UIImageView alloc] initWithFrame:model.rectView];//子弹数
    ...
    viewIntro.lbTitle=[[UILabel alloc] initWithFrame:model.rectTitle];//描述
    ...
    viewIntro.layerLine = [CAShapeLayer layer];//连接线
    ...
    viewIntro.layerLine.lineWidth =  5.0f;//线粗
