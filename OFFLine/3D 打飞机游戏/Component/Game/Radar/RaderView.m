...
-(void)setup
{
    ...
    radius=self.bounds.size.width/2.0-2;//弧度
    viewArc=[[UIView alloc] initWithFrame:self.bounds];//小地图 雷达
    ...
    layerPoint.fillColor = [UIColor colorWithRed:2 / 255.0 green:176 / 255.0 blue:240 / 255.0 alpha:0.3].CGColor;//扫描区域
...
-(void)drawRect:(CGRect)rect
{
    ...
    CGContextSetRGBStrokeColor(context, 0.1,0.1,0.1,0.5);//小地图边框颜色 圆盘
    CGContextSetRGBFillColor(context, 0.1,0.1,0.1,0.7);//小地图圆盘颜色
    ...
    for(NSNumber *key in dic)
    {
        ...
        CGContextSetRGBFillColor(context, 1,0,0,0.9);//小地图上敌人颜色
